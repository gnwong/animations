...
void try_set_parameter(const char *word, const char *value, Params *params) {
  ...
  set_by_word_val(word, value, "ix0", &(params->ix0), TYPE_INT);
  set_by_word_val(word, value, "ix1", &(params->ix1), TYPE_INT);
  set_by_word_val(word, value, "jy0", &(params->jy0), TYPE_INT);
  set_by_word_val(word, value, "jy1", &(params->jy1), TYPE_INT);
